...
const ServiceCard = ({ title, desc, tag, icon }) => {
  ...
  return (
      ...
      initial = {{ y: "100%", opacity: 0.2 }}
        ...
        className="group relative flex flex-col gap-5 items-center hover:-translate-y-2 transition-all duration-300 bg-(--nav-bg) rounded-3xl shadow-[0_10px_30px_rgba(0,0,0,0.05)] px-6 text-center py-10"
      >
        {tag && (
