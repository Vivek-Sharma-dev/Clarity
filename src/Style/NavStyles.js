...
export const navLinkBase =
  "relative transition-all duration-300 before:content-[''] before:absolute before:left-0 before:-bottom-2 before:w-0 before:h-1 before:bg-[var(--secondary-color)] before:transition-all before:duration-300 hover:text-white hover:before:w-full text-white/60 text-lg lg:text-lg cursor-pointer ";

export const navLinkActive = `relative transition-all duration-300 before:content-[''] before:absolute before:left-0 before:-bottom-2 before:w-0 before:h-1 before:bg-[var(--secondary-color)] before:transition-all before:duration-300 text-white before:w-full font-bold text-lg lg:text-lg `;
