    ...
    >
      <div className="lg:min-w-[33.33%] mx-3 card p-4 lg:p-8 rounded-2xl bg-(--nav-bg) border-t-6 border-(--secondary-color) hover:shadow-[0_0_0px_.5px_var(--secondary-color)] transition-all duration-300 ">
        <div className="flex items-center gap-4 ">
          ...
          <div>
            <h5 className="text-lg lg:text-xl font-medium capitalize">
              {name}
            </h5>
            <span className="text-gray-400 font-medium text-sm">{pos}</span>
        ...
        <div className="footer mt-5 flex flex-col lg:flex-row items-start lg:items-center lg:justify-between">
